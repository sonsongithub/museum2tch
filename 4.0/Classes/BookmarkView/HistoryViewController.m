...
- (void)pushDeleteButton:(id)sender {
	DNSLogMethod
	deleteAllSheet_ = [[UIActionSheet alloc] initWithTitle:LocalStr( @"Delete all cache?" ) 
												  delegate:self 
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	static NSString *CellIdentifier = @"HistoryViewCell";
	BookmarkViewCell *cell = (BookmarkViewCell*)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
	if (cell == nil) {
		cell = [[[BookmarkViewCell alloc] initWithFrame:CGRectZero reuseIdentifier:CellIdentifier] autorelease];
	}
...
- (void)tableView:(UITableView *)aTableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
	DNSLogMethod
	cellToDelete_ = indexPath.section * ROWS_PER_SECTION + indexPath.row;
	deleteAnItemSheet_ = [[UIActionSheet alloc] initWithTitle:LocalStr( @"Delete a cache?" )
												  delegate:self 
										 cancelButtonTitle:LocalStr( @"Cancel" )
									destructiveButtonTitle:LocalStr( @"Delete" )
										 otherButtonTitles:nil];
