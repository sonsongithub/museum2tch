...
@implementation ReplyViewCellEmail

@synthesize email = emailField_;
...
- (void) setupFont {
	...
	prompt_.frame = rect;
	CGRect new_field_rect = emailField_.frame;
	...
	emailField_.frame = new_field_rect;
}
